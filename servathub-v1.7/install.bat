...
echo.
echo ============================================
echo   servathub v1.7 - DeepSeek V4 Flash
echo   (Version stable sans Claude)
echo ============================================
echo.
...
echo Telechargement de servathub.exe (v1.0.5 - DeepSeek uniquement) ...
...
echo Version : v1.7 (DeepSeek V4 Flash uniquement)
echo.
exit /b 0
