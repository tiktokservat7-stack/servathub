# servathub v1.7 - DeepSeek V4 Flash uniquement
...
Write-Host ""
Write-Host "============================================"
Write-Host "  servathub v1.7 - DeepSeek V4 Flash"
Write-Host "  (Version stable sans Claude)"
Write-Host "============================================"
Write-Host ""
...
# 3. Telechargement
Write-Host "Telechargement de servathub.exe (v1.0.5 - DeepSeek uniquement) ..."
...
Write-Host ""
Write-Host "Termine ! Ouvre un NOUVEAU cmd et tape :  servathub"
Write-Host "Version : v1.7 (DeepSeek V4 Flash uniquement)"
Write-Host ""
